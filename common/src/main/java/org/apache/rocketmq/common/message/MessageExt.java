...
public class MessageExt extends Message {
    ...
    //队列偏移量 应该是这个消息 对应commitLog 的 偏移量
    private long queueOffset;
    //信息的  系统标示 代表这个信息 是 事务信息的哪种状态 或者是否是 压缩
    private int sysFlag;
    //创建时间
    ...
    //依 nio作为基本 容器  保存socket地址 到bytebuffer
    ...
    //没有直接返回 socketaddress 而是通过保存到bytebuffer 后 返回
