 ...
 */
//product 每个生产者 都绑定一个配置 用于再 producer 的实现类中绑定的 client中使用
public class ClientConfig {
    //vip标识
    public static final String SEND_MESSAGE_WITH_VIP_CHANNEL_PROPERTY = "com.rocketmq.sendMessageWithVIPChannel";
    //nameservice 的地址 从系统变量中获取
    ...
    //？？？ 应该是用来区分每个客户端个体的  默认是不区分 然后clientid 就一样了
    ...
    //创建 clientid  每个 client 应该都有一个唯一id便于定位  这里并不是通过 原子类 来设置自增id 而是通过一个 unitName 作为为仪表似乎
